...
## [Core Dialects](https://better-auth.com/docs/adapters/other-relational-databases\#core-dialects)
...
## [Kysely Organization Dialects](https://better-auth.com/docs/adapters/other-relational-databases\#kysely-organization-dialects)
...
## [Kysely Community dialects](https://better-auth.com/docs/adapters/other-relational-databases\#kysely-community-dialects)
...
You can see the full list of supported Kysely dialects [here](https://kysely.dev/docs/dialects).

[Edit on GitHub](https://github.com/better-auth/better-auth/blob/main/docs/content/docs/adapters/other-relational-databases.mdx)

### On this page

[Core Dialects](https://better-auth.com/docs/adapters/other-relational-databases#core-dialects) [Kysely Organization Dialects](https://better-auth.com/docs/adapters/other-relational-databases#kysely-organization-dialects) [Kysely Community dialects](https://better-auth.com/docs/adapters/other-relational-databases#kysely-community-dialects)
