...
Better Auth can be easily integrated with Next.js. Before you start, make sure you have a Better Auth instance configured. If you haven't done that yet, check out the [installation](https://better-auth.com/docs/installation).

### [Create API Route](https://better-auth.com/docs/integrations/next\#create-api-route)
...
## [Create a client](https://better-auth.com/docs/integrations/next\#create-a-client)
...
## [RSC and Server actions](https://better-auth.com/docs/integrations/next\#rsc-and-server-actions)
...
As RSCs cannot set cookies, the [cookie cache](https://better-auth.com/docs/concepts/session-management#cookie-cache) will not be refreshed until the server is interacted with from the client via Server Actions or Route Handlers.

### [Server Action Cookies](https://better-auth.com/docs/integrations/next\#server-action-cookies)
...
## [Auth Protection](https://better-auth.com/docs/integrations/next\#auth-protection)
...
### [Next.js 16+ (Proxy)](https://better-auth.com/docs/integrations/next\#nextjs-16-proxy)
...
### [Next.js 15.2.0+ (Node.js Runtime Middleware)](https://better-auth.com/docs/integrations/next\#nextjs-1520-nodejs-runtime-middleware)
...
### [Next.js 13-15.1.x (Edge Runtime Middleware)](https://better-auth.com/docs/integrations/next\#nextjs-13-151x-edge-runtime-middleware)
...
#### [For Next.js release `15.1.7` and below](https://better-auth.com/docs/integrations/next\#for-nextjs-release-1517-and-below)
...
#### [For Next.js release `15.2.0` and above](https://better-auth.com/docs/integrations/next\#for-nextjs-release-1520-and-above)
...
#### [Cookie-based checks (recommended for all versions)](https://better-auth.com/docs/integrations/next\#cookie-based-checks-recommended-for-all-versions)
...
### [How to handle auth checks in each page/route](https://better-auth.com/docs/integrations/next\#how-to-handle-auth-checks-in-each-pageroute)
...
## [Next.js 16 Compatibility](https://better-auth.com/docs/integrations/next\#nextjs-16-compatibility)

Better Auth is fully compatible with Next.js 16. The main change is that "middleware" is now called "proxy". See the [Auth Protection](https://better-auth.com/docs/integrations/next#auth-protection) section above for Next.js 16+ proxy examples.

### [Migration Guide](https://better-auth.com/docs/integrations/next\#migration-guide)
...
[Create API Route](https://better-auth.com/docs/integrations/next#create-api-route) [Create a client](https://better-auth.com/docs/integrations/next#create-a-client) [RSC and Server actions](https://better-auth.com/docs/integrations/next#rsc-and-server-actions) [Server Action Cookies](https://better-auth.com/docs/integrations/next#server-action-cookies) [Auth Protection](https://better-auth.com/docs/integrations/next#auth-protection) [Next.js 16+ (Proxy)](https://better-auth.com/docs/integrations/next#nextjs-16-proxy) [Next.js 15.2.0+ (Node.js Runtime Middleware)](https://better-auth.com/docs/integrations/next#nextjs-1520-nodejs-runtime-middleware) [Next.js 13-15.1.x (Edge Runtime Middleware)](https://better-auth.com/docs/integrations/next#nextjs-13-151x-edge-runtime-middleware) [For Next.js release `15.1.7` and below](https://better-auth.com/docs/integrations/next#for-nextjs-release-1517-and-below) [For Next.js release `15.2.0` and above](https://better-auth.com/docs/integrations/next#for-nextjs-release-1520-and-above) [Cookie-based checks (recommended for all versions)](https://better-auth.com/docs/integrations/next#cookie-based-checks-recommended-for-all-versions) [How to handle auth checks in each page/route](https://better-auth.com/docs/integrations/next#how-to-handle-auth-checks-in-each-pageroute) [Next.js 16 Compatibility](https://better-auth.com/docs/integrations/next#nextjs-16-compatibility) [Migration Guide](https://better-auth.com/docs/integrations/next#migration-guide)
